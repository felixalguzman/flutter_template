...
part of 'scaffold_provider.dart';
...
String _$scaffoldMessengerHash() => r'f1f1a7153020a12a715d48b2459d56b05c8692f9';

/// Returns the scaffold messenger associated with [scaffoldMessengerKeyProvider].
///
///
/// Copied from [scaffoldMessenger].
@ProviderFor(scaffoldMessenger)
final scaffoldMessengerProvider =
    AutoDisposeProvider<ScaffoldMessengerState>.internal(
  scaffoldMessenger,
...
typedef ScaffoldMessengerRef = AutoDisposeProviderRef<ScaffoldMessengerState>;
